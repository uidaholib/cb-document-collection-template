...
A customized version of CollectionBuilder-CSV for use with University of Idaho Library Digital Collections, modified to support document-focused collections.
